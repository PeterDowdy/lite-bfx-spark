 ...
 *
 * <p>For gzipped files ({@code .fastq.gz} / {@code .fq.gz}), a single partition
 * is created with {@code startByte=0} and {@code endByte=Long.MAX_VALUE} because
 * gzip streams are not seekable.
 *
...
public class FastqInputPartition implements InputPartition, Serializable {
    ...
    public FastqInputPartition(String path, long startByte, long endByte, Configuration hadoopConf) {
        this(path, startByte, endByte, hadoopConf, null);
    }
